...
task test1d_distrib()
  ...
  -- Important: this overwrites r and s!
  fft1d.make_plan_distrib(r, r_part, s, s_part, p, p_part, 1)
  fill(r, 0)
  fill(s, 0)
...
task test2d_distrib()
  ...
  var p_part = partition(equal, p, ispace(int1d, n))
  -- Important: this overwrites r and s!
  fft2d.make_plan_distrib(r, r_part, s, s_part, p, p_part, 1)
  fill(r, 0)
  fill(s, 0)
  __demand(__index_launch)
  for i in r_part.colors do
